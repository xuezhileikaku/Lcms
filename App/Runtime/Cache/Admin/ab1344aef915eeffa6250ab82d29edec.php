            ...
            <div id="chart-container" class="block-body collapse in" >
                <table class="table table-striped">
                    ...
                    <?php if(is_array($co)): $k = 0; $__LIST__ = $co;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$c): $mod = ($k % 2 );++$k;?><tr>
                            ...
                            <td><a href="/manage/index.php/Admin/Course/edt/co/<?php echo ($c["co_id"]); ?>">编辑</a>&nbsp;&nbsp;<a  href="/manage/index.php/Admin/Course/del/co/<?php echo ($c["co_id"]); ?>">删除</a>&nbsp;&nbsp;<a  href="/manage/index.php/Admin/Chapter/index/co/<?php echo ($c["co_id"]); ?>">详细</a>&nbsp;&nbsp;<a href="/manage/index.php/Admin/Pack/index/co/<?php echo ($c["co_id"]); ?>">打包课程</a></td>
