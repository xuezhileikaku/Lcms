    ...
    <div class="row-fluid">
        <div class="block">
            ...
            <div id="chart-container" class="block-body collapse in">
                <div>
                    <form action="/manage/index.php/Admin/Gp/up" method="post">
                       小组名称：<input type="text" name="up_name" value="<?php echo ($up["up_name"]); ?>" /><br/>
                       小组介绍：<textarea name="up_intro" rows="2"><?php echo ($up["up_intro"]); ?></textarea><br/>
                            <input type="hidden" name="up_id" value="<?php echo ($up["up_id"]); ?>" />
