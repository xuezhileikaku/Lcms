                ...
                <div class=''>
                     <form action="/manage/index.php/Admin/Course/up" method="post" ecncype='application/x-www-form-urlencoded' >
                        <div class="form-group">
                            <br/>
                            课程：
                            <input type="text" name="co_name" class="form-control" value="<?php echo ($dat["co_name"]); ?>"/>&nbsp;&nbsp;&nbsp;&nbsp;
                            类型：<select name="co_type" style="width:15%;">
                                <option value="<?php echo ($dat["co_type"]); ?>"> 请选择</option>
                           ...
                           学科类别:
                            <select name="co_cat">
                                ...
                                <?php if(is_array($cat)): $k = 0; $__LIST__ = $cat;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$c): $mod = ($k % 2 );++$k;?><option value="<?php echo ($k); ?>"> <?php echo ($c); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                            </select>   &nbsp;&nbsp;&nbsp;&nbsp;
                            负责人:
                            <input id="manager" type="text" name="co_manager" value="<?php echo ($dat["co_manager"]); ?>"/>

                        </div>
                        <div class="form-group"> 结束： <input type="text" id="end" value="<?php echo ($dat["co_time_e"]); ?>" class="laydate-icon" name="co_time_e" onClick="laydate({istime: true, format: 'YYYY-MM-DD hh:mm:ss'})" />
                        </div>
                        <div class="form-group">
