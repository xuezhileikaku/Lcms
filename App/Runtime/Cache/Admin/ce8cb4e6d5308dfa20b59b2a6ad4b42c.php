...
<div class="span9">
    ...
    <div class="row-fluid">
        <div class="block">
            <p class="block-heading" data-toggle="collapse" data-target="#chart-container">添加人员</p>
            <div id="chart-container" class="block-body collapse in">
                <div class="form-group">
                    <form action="/manage/index.php/Admin/User/up" method="post">
                        <label>姓名：</label>
                        <input type="text" name="u_name"  class="form-control" value="<?php echo ($user["u_name"]); ?>" /><br/>
                        <label>职位：</label>
                        <select name="u_pos">
                            <option value="<?php echo ($user["u_u_pos"]); ?>"  >请选择</option>
                            <?php if(is_array($up['name'])): $k = 0; $__LIST__ = $up['name'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$u): $mod = ($k % 2 );++$k;?><option value="<?php echo ($k); ?>"><?php echo ($u); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                        </select><br/>
                        <label>邮箱：</label>
                        <input type="text" name="u_email" class="form-control" value="<?php echo ($user["u_email"]); ?>" /><br/>
                        <label>电话：</label>
                        <input type="text" name="u_tel" class="form-control" value="<?php echo ($user["u_tel"]); ?>" /><br/>
                        <label>qq:</label>
                        <input type="text" name="u_qq" class="form-control" value="<?php echo ($user["u_qq"]); ?>" /><br/>
