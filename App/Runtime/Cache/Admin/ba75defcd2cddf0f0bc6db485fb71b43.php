                ...
                <table class="table table-striped">
                    <thead>
                        <tr>
                            ...
                            <td style='width: 14%;'>部门名称</td>
                            <td style='width: 24%;'>介绍</td>
                            <td >成员</td>
                             <td style='width: 14%;'>操作</td>
                        </tr>
                    </thead>
                    <tbody>
                    <?php  foreach($up as $k=>$v){ echo "<tr><td >".($k+1)."</td><td>".$v['up_name']."</td><td>".$v['up_intro']."</td><td>"; foreach($v['user'] as $key=>$va){ echo "<a href='".$key."'>".$va."</a>&nbsp;&nbsp;"; } echo "</td><td><a href='/manage/index.php/Admin/Gp/edt/id/".$v['up_id']."'>编辑</a>&nbsp;&nbsp;<a  href='/manage/index.php/Admin/Gp/del/id/".$v['up_id']."'>删除</a></td></tr>"; } ?>
                            
                    <form action="/manage/index.php/Admin/Gp/add" method="post">
                        <tr id="add">
                            <td></td>
