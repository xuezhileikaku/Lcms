...
<div class="span9">
    ...
    <div class="row-fluid">
        <div class="block">
            <p class="block-heading" data-toggle="collapse" data-target="#chart-container">编辑章节信息
            </p>
            <div id="chart-container" class="block-body collapse in">
                <form>
                    <div>
                        <h3>
                            <input nam="ch_name" style="width: 4%;" value="<?php echo ($ch["ch_num"]); ?>"  readonly="readonly"/> 章&nbsp;&nbsp;&nbsp;&nbsp;<input nam="ch_name" value="<?php echo ($ch["ch_name"]); ?>" /><br/>
                        </h3>
                        负责人：<input type="text" name="ch_manager" style="width: 14%;" value="<?php echo ($ch["ch_manager"]); ?>"/>
                        课程进度：<input type="text" name="ch_process" value="<?php echo ($ch["ch_process"]); ?>"/><br/>
                        设置章节模块：<input type="checkbox" name="ch_modu" value=""/>教学设计<input type="checkbox" name="ch_modu" value=""/>视频动画<input type="checkbox" name="ch_modu" value=""/>素材
