...
<div class="span9">
    <h1 class="page-title" aling="center">人员管理</h1>
    <div class="row-fluid">
        <div class="block">
            <p class="block-heading" data-toggle="collapse" data-target="#chart-container" align="center">人员列表<span style="float: right;"><a href="/manage/index.php/Admin/User/add">添加人员</a></span></p>
            <div id="chart-container" class="block-body collapse in">
                <table class="table table-striped">
                    ...
                    <tbody>
                    <?php if(is_array($user)): $k = 0; $__LIST__ = $user;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$u): $mod = ($k % 2 );++$k;?><tr>
                            <td><?php echo ($k); ?></td>
                            <td><a href="/manage/index.php/Admin/User/index/id/<?php echo ($u["u_id"]); ?>" title="点击查看详细"><?php echo ($u["u_name"]); ?></a></td>
                            <td><?php echo ($u["u_pos"]); ?></td>
                            <td><?php echo ($u["u_email"]); ?></td>
                            <td><?php echo ($u["u_tel"]); ?></td>
                            <td><?php echo ($u["u_qq"]); ?></td>
                            <td><a href="/manage/index.php/Admin/User/edt/id/<?php echo ($u["u_id"]); ?>">编辑</a>&nbsp;&nbsp;<a  href="/manage/index.php/Admin/User/del/id/<?php echo ($u["u_id"]); ?>">删除</a></td>
