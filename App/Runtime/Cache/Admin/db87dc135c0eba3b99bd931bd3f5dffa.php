...
<div class="span9">
    ...
    <div class="row-fluid">
        <div class="block">
            <p class="block-heading" data-toggle="collapse" data-target="#chart-container"><a href='/manage/index.php/Admin/Course/index'>课程</a>-》编辑章节信息
            </p>
            <div id="chart-container" class="block-body collapse in">
                <form action='/manage/index.php/Admin/Chapter/up' method='post'>
                    <div>
                        <h3>
                            <input name="ch_num" style="width: 4%;" value="<?php echo ($ch["ch_num"]); ?>"  readonly="readonly"/> 章&nbsp;&nbsp;&nbsp;&nbsp;<input name="ch_name" value="<?php echo ($ch["ch_name"]); ?>" /><br/>
                        </h3>
